...
const ItemForm = ({ item, confirm, handleError, cancel }: ItemFormProps) => {
  ...
  const defaultValues: ItemFormValues = {
    ...
    depositAmount: 10,
    rentPrice: 10,
    agency: '', // TODO replace with connected user agency
    itemType: '',
    tags: [],
    images: [],
  ...
  const { setValue, getValues, handleSubmit, control } = useForm<ItemFormValues>({
    defaultValues,
  ...
  const submitHandler = (values: ItemFormValues) =>
  ...
  return (
    <div style={{ width: 900 }} className="root flex flex-col items-center justify-center mb-1">
      <Typography
        variant="h1"
        style={{
          fontSize: '1.5rem',
